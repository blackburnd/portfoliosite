...
('r_fullprofile', 'Complete Profile Data', 'Access to complete profile data including positions', 'Work experience, education, skills, detailed profile', false, 4),
...
('rw_company_admin', 'Company Administration', 'Access to company pages (if admin)', 'Company page information for pages you admin', false, 6)
